    ...
    return {
      chart_data:[
        ...
        chart_data_list: {
          ...
          5: {url: 'vaccine/vaccination/', var: 'cases_new'},
          6: {url: 'facilities/hospitals/', var: 'cases_new'},
          7: {url: 'facilities/icu/', var: 'cases_new'},
          8: {url: 'facilities/pkrc/', var: 'cases_new'},
        ...
        data_items: [
          ...
          { name: 'Vaccination', value: '5'},
          { name: 'Hospitals', value: '6'},
          { name: 'ICU', value: '7'},
          { name: 'PKRC', value: '8'},
